        ...
        <div class="col-12">
            <div class="row">
                ...
                <nav class="navbar navbar-expand-sm bg-light navbar-light">
                    <!-- Brand -->
                    <a class="navbar-brand" href="index.php?action=hanghoa&act=hanghoa">Logo</a>

                    <!-- Links -->
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?action=hanghoa&act=hanghoa">Trang Chủ</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="index.php?action=loaisp">Loại Sản Phẩm</a>
                                <a class="dropdown-item" href="">Sản Phẩm</a>
                                <a class="dropdown-item" href="index.php?action=menu">Loại menu</a>
                            </div>
                        </li>
                        <!-- Thống kê -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="index.php?action=hanghoa&act=thongke">Sản Phẩm bán được nhiều Nhất</a>
